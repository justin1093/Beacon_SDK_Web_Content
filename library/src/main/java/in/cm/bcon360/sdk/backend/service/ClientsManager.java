...
// changes done to test the beacon
    ...
    protected BeaconEvent getBeaconEventNew(String beaconUniqueId) {
        BeaconModel bm = getMonitoredBeaconModel(beaconUniqueId);
        BeaconEvent be = (bm == null ? null : monitoredBeacons.get(bm));
    ...
    private void notifyClientsAboutAction(BeaconModel bm, Map<String, List<Trigger>> eventTriggers, EventInfo eventInfo) {
        ...
        ULog.d(TAG, "Notify client" + eventTriggers.size());
